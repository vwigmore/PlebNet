...
sshpass -p${PASSWORD} ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@${IP} 'wget https://raw.githubusercontent.com/vwigmore/plebnet/end2end_btc/plebnet/clone/install.sh && \
    chmod +x install.sh && \
